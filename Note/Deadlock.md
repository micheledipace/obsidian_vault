...
# Deadlock
Stato di attesa indefinito. Accade quando un processo è in attesa di risorse da processi che sono anch'essi in attesa.
...
- Possesso e attesa
	...
	L'assenza di questa condizione comporta possibilità starvation. (un processo possiede tutte le risorse necessarie o non ne possiede nessuna e non verrà mai eseguito)
- Attesa circolare
